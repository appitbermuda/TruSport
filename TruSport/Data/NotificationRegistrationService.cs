...
namespace TruSport.Data
{
    ...
    {
        const string RequestUrl = "pushnotification/installations";
        ...
        public NotificationRegistrationService()
        {
            ...
            _baseApiUrl = Constants.APIEndpoint;
        }

        IDeviceInstallationService DeviceInstallationService
            => _deviceInstallationService ??
                (_deviceInstallationService = PushServiceContainer.Resolve<IDeviceInstallationService>());
