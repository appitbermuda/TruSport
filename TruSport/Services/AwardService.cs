...
namespace TruSport.Services
{
    public class AwardService
    {
        ...
        public async Task<List<Award>> GetBasketballPlayerOfTheWeek()
        {
            try
            {
                var client = new RestClient(Constants.APIEndpoint);
                var request = new RestRequest("Award/BasketballPlayerOfTheWeek", Method.GET);
        ...
        public async Task<List<Award>> GetBasketballPlayerOfTheMonth()
        {
            try
            {
                var client = new RestClient(Constants.APIEndpoint);
                var request = new RestRequest("Award/BasketballPlayerOfTheMonth", Method.GET);
        ...
        public async Task<List<Award>> GetBasketballPlayerOfTheYear()
        {
            try
            {
                var client = new RestClient(Constants.APIEndpoint);
                var request = new RestRequest("Award/BasketballPlayerOfTheYear", Method.GET);
