...
namespace TruSport.Views.Tennis
{
    ...
    public partial class TennisMasterDetailPageDetail : ContentPage
    {
        TennisPageViewModel tennisPageViewModel;

        public TennisMasterDetailPageDetail()
        {
            NavigationPage.SetHasNavigationBar(this, false);
            tennisPageViewModel = new TennisPageViewModel(Navigation);

            InitializeComponent();

            this.BindingContext = tennisPageViewModel;
        ...
        private async void PullToRefreshPastFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            await tennisPageViewModel.RefreshPastFixtures();
        ...
        private async void PullToRefreshUpcomingFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            await tennisPageViewModel.RefreshUpcomingFixtures();
        ...
        private async void PullToRefreshLiveFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            //await tennisPageViewModel.RefreshLiveFixtures();
        ...
        async void PastFixtureSelected(object sender, Syncfusion.ListView.XForms.ItemSelectionChangedEventArgs e)
        {
            ...
            var item = (TennisFixture)PastFixtureList.SelectedItem;
        ...
        async void UpcomingFixtureSelected(object sender, Syncfusion.ListView.XForms.ItemSelectionChangedEventArgs e)
        {
            ...
            var item = (TennisFixture)UpcomingFixtureList.SelectedItem;
        ...
        async void LiveFixtureSelected(object sender, Syncfusion.ListView.XForms.ItemSelectionChangedEventArgs e)
        {
            ...
            var item = (TennisFixture)LiveFixtureList.SelectedItem;
        ...
        {
            if (tennisPageViewModel.IsUpcomingCalendarVisible)
            {
                tennisPageViewModel.IsUpcomingCalendarVisible = false;
        ...
        private bool FilterPreviousFixtures(object obj)
        {
            ...
            try
            {
                if (fixture.TournamentMatchType.Tournament.Name.ToLower().Contains(previousSearchBar.Text.ToLower())
                    || fixture.TennisMatch[0].Player1.Player.Name.ToLower().Contains(previousSearchBar.Text.ToLower())
                    || (fixture.TennisMatch[0].Player2 != null && fixture.TennisMatch[0].Player2.Player.Name.ToLower().Contains(previousSearchBar.Text.ToLower()))
                    || fixture.Date.ToString().ToLower().Contains(previousSearchBar.Text.ToLower())
                    || fixture.TennisMatch[1].Player1.Player.Name.ToLower().Contains(previousSearchBar.Text.ToLower())
                    || (fixture.TennisMatch[1].Player2 != null && fixture.TennisMatch[1].Player2.Player.Name.ToLower().Contains(previousSearchBar.Text.ToLower())))
                    return true;
                else
                    return false;
            }
