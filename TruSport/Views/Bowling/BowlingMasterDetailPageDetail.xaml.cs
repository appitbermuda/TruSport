...
namespace TruSport.Views.Bowling
{
    ...
    public partial class BowlingMasterDetailPageDetail : ContentPage
    {
        BowlingPageViewModel bowlingPageViewModel;

        public BowlingMasterDetailPageDetail()
        {
            NavigationPage.SetHasNavigationBar(this, false);
            bowlingPageViewModel = new BowlingPageViewModel(Navigation);

            InitializeComponent();

            this.BindingContext = bowlingPageViewModel;
        ...
        private async void PullToRefreshPastFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            await bowlingPageViewModel.RefreshPastFixtures();
        ...
        private async void PullToRefreshUpcomingFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            await bowlingPageViewModel.RefreshUpcomingFixtures();
        ...
        async void PastFixtureSelected(object sender, Syncfusion.ListView.XForms.ItemSelectionChangedEventArgs e)
        {
            ...
            var item = (BowlingFixture)PastFixtureList.SelectedItem;
        ...
        async void UpcomingFixtureSelected(object sender, Syncfusion.ListView.XForms.ItemSelectionChangedEventArgs e)
        {
            ...
            var item = (BowlingFixture)UpcomingFixtureList.SelectedItem;
        ...
        {
            if (bowlingPageViewModel.IsUpcomingCalendarVisible)
            {
                bowlingPageViewModel.IsUpcomingCalendarVisible = false;
