...
namespace TruSport.Views
{
    ...
    public partial class FootballMasterDetailPageDetail : ContentPage
    {
        FootballPageViewModel footballPageViewModel;

        public FootballMasterDetailPageDetail()
        {
            NavigationPage.SetHasNavigationBar(this, false);
            footballPageViewModel = new FootballPageViewModel(Navigation);

            this.BindingContext = footballPageViewModel;
            InitializeComponent();
        ...
        private async void PullToRefreshPastFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            await footballPageViewModel.RefreshPastFixtures();
        ...
        private async void PullToRefreshUpcomingFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            await footballPageViewModel.RefreshUpcomingFixtures();
        ...
        private async void PullToRefreshLiveFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            await footballPageViewModel.RefreshLiveFixtures();
        ...
        {
            if (footballPageViewModel.IsUpcomingCalendarVisible)
            {
                footballPageViewModel.IsUpcomingCalendarVisible = false;
