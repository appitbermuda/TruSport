...
namespace TruSport.Views.Cricket
{
    public partial class FavouritePage : ContentPage
    {
        ...
        async void TeamSelected(object sender, Syncfusion.ListView.XForms.ItemSelectionChangedEventArgs e)
        {
            ...
            await Navigation.PushAsync(new Cricket.TeamProfilePage(item));
        ...
        async void FixtureSelected(object sender, Syncfusion.ListView.XForms.ItemSelectionChangedEventArgs e)
        {
            ...
            var item = (CricketFixture)FavouriteFixtureList.SelectedItem;

            await Navigation.PushAsync(new Cricket.FixtureDetailsPage(item));
