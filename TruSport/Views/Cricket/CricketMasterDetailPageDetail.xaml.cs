...
namespace TruSport.Views.Cricket
{
    ...
    public partial class CricketMasterDetailPageDetail : ContentPage
    {
        CricketPageViewModel cricketPageViewModel;

        public CricketMasterDetailPageDetail()
        {
            NavigationPage.SetHasNavigationBar(this, false);
            cricketPageViewModel = new CricketPageViewModel(Navigation);

            this.BindingContext = cricketPageViewModel;
        ...
        private async void PullToRefreshPastFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            await cricketPageViewModel.RefreshPastFixtures();
        ...
        private async void PullToRefreshUpcomingFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            await cricketPageViewModel.RefreshUpcomingFixtures();
        ...
        private async void PullToRefreshLiveFixtures_Refreshing(object sender, EventArgs args)
        {
            ...
            await cricketPageViewModel.RefreshLiveFixtures();
        ...
        {
            if (cricketPageViewModel.IsUpcomingCalendarVisible)
            {
                cricketPageViewModel.IsUpcomingCalendarVisible = false;
