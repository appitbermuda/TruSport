...
using TruSport.ViewModels.Triathlon;
using Xamarin.Forms;

namespace TruSport.Views.Triathlon
{
    public partial class TriathlonMainPage : ContentPage
    {
        TriathlonPageViewModel triathlonPageViewModel;

        public TriathlonMainPage()
        {
            NavigationPage.SetHasNavigationBar(this, false);
            triathlonPageViewModel = new TriathlonPageViewModel(Navigation);

            InitializeComponent();

            this.BindingContext = triathlonPageViewModel;
