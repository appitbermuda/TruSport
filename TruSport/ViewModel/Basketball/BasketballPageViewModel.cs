...
{
    public class BasketballPageViewModel : BaseViewModel
    {
        #region Fields
        ...
        private ObservableCollection<BasketballFixture> pastCollection;
        private ObservableCollection<BasketballFixture> upcomingCollection;
        private ObservableCollection<LiveBasketballFixture> liveCollection;
        ...
        public BasketballPageViewModel(INavigation navigation)
        {
            Navigation = navigation;

            PastCollection = new ObservableCollection<BasketballFixture>();
            UpcomingCollection = new ObservableCollection<BasketballFixture>();
            LiveCollection = new ObservableCollection<LiveBasketballFixture>();
        ...
        public ObservableCollection<BasketballFixture> PastCollection
        {
            get { return pastCollection; }
            set { Set(ref pastCollection, value); }
        }

        public ObservableCollection<BasketballFixture> UpcomingCollection
        {
            get { return upcomingCollection; }
            set { Set(ref upcomingCollection, value); }
        }

        public ObservableCollection<LiveBasketballFixture> LiveCollection
        {
        ...
        internal async void GenerateSource()
        {
            ...
            try
            {
                ...
                var awards = await awardService.GetBasketballPlayerOfTheWeek();
                ...
                if (current == NetworkAccess.Internet)
                {
                    ...
                    var pastFixtures = await fixtureService.GetPastBasketballFixtures();
                    if (pastFixtures != null)
                    {
                        ...
                        if (pastFixtures.Count() > 0)
                        {
                            ...
                            PastCollection = new ObservableCollection<BasketballFixture>(pastFixtures.OrderByDescending(e => e.FixtureTime));
                        }
                        else
                        {
                    ...
                    var upcomingFixtures = await fixtureService.GetUpcomingBasketballFixtures();
                    if (upcomingFixtures != null)
                    {
                        //var upcomingFixtures = fixtures.Where(e => e.FixtureTime.AddMinutes(110) >= DateTime.Now);
                        UpcomingCollection = new ObservableCollection<BasketballFixture>(upcomingFixtures.OrderBy(e => e.FixtureTime));
                    ...
                    var liveFixtures = await fixtureService.GetLiveBasketballFixtures();
                    ...
                    { 
                        ...
                        if (liveFixtures.Count() > 0)
                        {
                            ...
                            LiveCollection = new ObservableCollection<LiveBasketballFixture>(liveFixtures);
                        }
                        else
                        {
                            RefreshActive = false;
        ...
        internal async Task RefreshFixtures()
        {
            try
            {
                ...
                if (current == NetworkAccess.Internet)
                {
                    ...
                    if (pastFixtures != null)
                    {
                        PastCollection = new ObservableCollection<BasketballFixture>(pastFixtures);
                    }
                    //var upcomingFixtures = fixtures.Where(e => e.FixtureTime.AddMinutes(110) >= DateTime.Now);
                    var upcomingFixtures = await fixtureService.GetUpcomingBasketballFixtures();
                    if (upcomingFixtures != null)
        ...
        internal async Task RefreshPastFixtures()
        {
            try
            {
                var fixtures = await fixtureService.GetPastBasketballFixtures();
        ...
        internal async Task RefreshFixturesTimer()
        {
            try
            {
                if (!RefreshActive)
                {
                    var fixtures = await fixtureService.GetBasketballFixtures();
        ...
        {
            var item = e.ItemData as BasketballFixture;
