...
namespace TruSport.ViewModels.Cricket
{
    public class FavouritePageViewModel : BaseViewModel
    {
        ...
        private ObservableCollection<CricketFixture> favouriteFixturesCollection;
        ...
        public ObservableCollection<CricketFixture> FavouriteFixturesCollection
        {
        ...
        internal async void GenerateSource()
        {
            try
            {
                ...
                if (current == NetworkAccess.Internet)
                {
                    ...
                    var favouriteTeams = await App.Database.GetCricketTeamFavourites();
                    ...
                    var favouriteFixtures = await App.Database.GetCricketFixtureFavourites();
        ...
        public async void DeleteFixtureFavourite(object obj)
        {
            try
            {
                ...
                await App.Database.DeleteCricketFixtureFavourite(fixture.ID);
