...
namespace TruSport.ViewModels
{
    public class FixtureDetailPageViewModel : BaseViewModel
    {
        ...
        public FixtureDetailPageViewModel(INavigation navigation, Fixture fixture)
        {
        ...
        internal async void GenerateSource(Fixture fixtureItem)
        {
            ...
            try
            {
                ...
                TableCollection = new ObservableCollection<LeagueTable>(fixture.LeagueTable);

                HeadToHeadFixtureCollection = new ObservableCollection<Fixture>(fixture.HeadToHead);
        ...
        internal async Task RefreshFixtures()
        {
            try
            {
                ...
                if (current == NetworkAccess.Internet)
                {
                    ...
                    FixtureItem = await fixtureService.GetFootballFixture(FixtureItem.ID);
                }
                else
                    NoConnectivity = true;
            }
            ...
            {
                Debug.WriteLine(ex.Message, "Fixture Refresh");
            }
        }
