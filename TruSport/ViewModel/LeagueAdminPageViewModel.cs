...
{
    public class LeagueAdminPageViewModel : BaseViewModel
    {
        #region Fields
        private TeamListView tappedInfo;
        private League leagueItem;
        ...
        public LeagueAdminPageViewModel()
        {
        ...
        public LeagueAdminPageViewModel(League league)
        {
            LeagueCollection = new ObservableCollection<League>();
        ...
        public League LeagueItem
        {
            get { return leagueItem; }
            set { this.leagueItem = value; }
        }

        public ObservableCollection<League> LeagueCollection
        {
            get { return leagueCollection; }
            set { this.leagueCollection = value; }
        }
        ...
        internal async void GenerateSource(League team)
        {
        ...
        internal async void GenerateSource()
        {
            ...
            //var leagues = await databaseManager.GetAllLeagues();
            //foreach (var league in leagues)
            //{
            //    LeagueCollection.Add(league);
            //}
