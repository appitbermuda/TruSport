...
namespace OnTrackWebService.Repository
{
    public class EmailRepository : IEmailRepository<string>
    {
        ...
        public async Task SendCustomerSignUpEmail(Customer customer)
        {
            try
            {
                ...
                body = @"<html>
                    ...
                    <p>[Name] has just signed for tickets.</p>
        ...
        public async Task<bool> SendPaymentConfirmation(Customer customer, string referenceNumber, decimal payment, decimal processingFee)
        {
