...
namespace OnTrackWebService.Data
{
    public static class Roles
    {
        ...
        public const string TicketAdmin = "Administrator,Ticketing Administrator (Football),Ticketing Owner (Football)";
        public const string TicketOwner = "Administrator,Ticketing Owner (Football)";
