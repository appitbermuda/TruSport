...
namespace OnTrackWebService.Models.Shop
{
    public class Request
    {
        public async Task<AuthorizeResponse> Payment(PaymentAuthorize paymentAuthorize)
        {
            ...
            if (paymentAuthorize.SaveCard)
            {
                request.TransactionDetails.TransactionCode = 136;
                request.TransactionDetails.CustomerReference = paymentAuthorize.CustomerID;
            }
            else
        ...
        public async Task<AuthorizeResponse> AuhtorizePayment(PaymentAuthorize paymentAuthorize)
        {
            var client = new ServicesClient();
            var request = new AuthorizeRequest();
            var transactionRequest = new TransactionModificationRequest();
            ...
            //request.TransactionDetails.IPAddress = "";
            request.TransactionDetails.MerchantId = Constants.MerchantId;
            request.TransactionDetails.OrderNumber = "TIX_" + DateTime.Now.Ticks.ToString("000000000000");
        ...
        public async Task<AuthorizeResponse> Authorize(PaymentAuthorize paymentAuthorize)
        {
            var client = new ServicesClient();
            var request = new AuthorizeRequest();
            var transactionRequest = new TransactionModificationRequest();
        ...
        public async Task<AuthorizeResponse> Capture(PaymentAuthorize paymentAuthorize)
        {
            var client = new ServicesClient();
            var request = new AuthorizeRequest();
            var transactionRequest = new TransactionModificationRequest();
