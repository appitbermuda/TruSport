...
namespace OnTrackWebService.Models
{
    public class SportFeature
    {
        ...
        public string HomeBasketballImage { get; set; }
        public string HomeFieldHockeyImage { get; set; }
        public string HomeGolfImage { get; set; }
        public string HomeCyclingImage { get; set; }
    }
}
